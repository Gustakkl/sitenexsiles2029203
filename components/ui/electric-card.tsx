...
export const ElectricCard = ({
  ...
  const ids = useMemo(() => {
    // Generate a simple random id if running client-side, or use a consistent one
  ...
  return (
    <div className={`ec-wrap ${className}`}>
      ...
      <div className="card-container" style={{ ["--electric-border-color" as any]: color, ["--f" as any]: filterURL } as React.CSSProperties}>
